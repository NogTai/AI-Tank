    ...
    if (this.m_start) {
      ...
      if (x != null) {
        if (
          this.m_x >= x &&
          this.m_y >= y &&
          this.m_x + this.m_w <= x + w &&
          this.m_y + this.m_h <= y + h
        ) {
        } else {
          return;
        }
      ...
      if (this.m_drawAdd)
        this.m_graphicEngine.SetDrawModeAddActive(context, true);
      this.m_graphicEngine.Draw(
        context,
        sourceRect.m_id,
        sourceRect.m_x,
        sourceRect.m_y,
        sourceRect.m_w,
        sourceRect.m_h,
        (this.m_x - offsetX - this.m_w * 0.5) >> 0,
        (this.m_y - offsetY - this.m_h * 0.5) >> 0,
        this.m_w,
        this.m_h,
        this.m_alpha,
        0,
      ...
      if (this.m_drawAdd)
        this.m_graphicEngine.SetDrawModeAddActive(context, false);
    }
  };
    ...
    if (this.m_start) {
      ...
      for (var i = 0; i < emitNumber; i++) {
        ...
        if (tempParticle != null) {
          ...
          // Force and direction
          var randomAngle =
            Math.random() * (this.m_emitAngleEnd - this.m_emitAngleStart) +
            this.m_emitAngleStart;
          randomAngle = randomAngle % 360;
          randomAngle *= degToRad;
          var randomForce =
            Math.random() * (this.m_emitForceMax - this.m_emitForceMin) +
            this.m_emitForceMin;
          ...
          if (this.m_randomizeLifeMax == 0 && this.m_randomizeLifeMin == 0) {
            ...
            var randomLife =
              Math.random() *
                (this.m_randomizeLifeMax - this.m_randomizeLifeMin) +
              this.m_randomizeLifeMin;
          ...
          if (this.m_randomizeAngleMax == 0 && this.m_randomizeAngleMin == 0) {
            ...
            var randomAngle =
              Math.random() *
                (this.m_randomizeAngleMax - this.m_randomizeAngleMin) +
              this.m_randomizeAngleMin;
          ...
          if (
            ...
            var randomSpeed =
              Math.random() *
                (this.m_randomizeRotateSpeedMax -
                  this.m_randomizeRotateSpeedMin) +
              this.m_randomizeRotateSpeedMin;
          ...
          if (this.m_randomizeScaleMin == 0 && this.m_randomizeScaleMax == 0) {
            ...
            var randomScale =
              Math.random() *
                (this.m_randomizeScaleMax - this.m_randomizeScaleMin) +
              this.m_randomizeScaleMin;
