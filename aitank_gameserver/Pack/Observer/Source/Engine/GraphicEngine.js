    ...
    if (navigator.isCocoonJS) {
      for (var i = 0; i < textRequest.length; i++) {
        if (
          ...
          if (alignW == "left")
            context.drawImage(
              textRequest[i].m_canvas,
              0,
              0,
              textRequest[i].m_canvas.width,
              textRequest[i].m_canvas.height,
              x,
              y - size * LINE_HEIGHT,
              textRequest[i].m_canvas.width,
              textRequest[i].m_canvas.height
      ...
      if (navigator.isCocoonJS) {
        ...
        for (var i = 0; i < lineArray.length; i++) {
          if (alignW == "left") {
            ...
            if (stroke)
              tempContext.strokeText(
                lineArray[i],
                0,
                (i + 1) * size * LINE_HEIGHT
              );
          } else if (alignW == "center") {
