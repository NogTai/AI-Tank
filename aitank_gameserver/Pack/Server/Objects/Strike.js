      ...
      if (this.m_countDown > 0) {
        ...
        if (this.m_type == Enum.POWERUP_AIRSTRIKE) {
          for (var i = 0; i < game.m_tanks[Enum.TEAM_1].length; i++) {
            ...
            if (tempTank.m_HP > 0) {
              if (
                (this.m_x - tempTank.m_x) * (this.m_x - tempTank.m_x) +
                  (this.m_y - tempTank.m_y) * (this.m_y - tempTank.m_y) <=
                Setting.AIRSTRIKE_AOE * Setting.AIRSTRIKE_AOE
              ) {
          ...
          for (var i = 0; i < game.m_obstacles.length; i++) {
            ...
            if (tempObstacle.m_HP > 0) {
              if (
                (this.m_x - tempObstacle.m_x) * (this.m_x - tempObstacle.m_x) +
                  (this.m_y - tempObstacle.m_y) *
                    (this.m_y - tempObstacle.m_y) <=
                Setting.AIRSTRIKE_AOE * Setting.AIRSTRIKE_AOE
              ) {
          ...
          for (var i = 0; i < game.m_bases[Enum.TEAM_1].length; i++) {
            ...
            if (tempBase.m_HP > 0) {
              if (
                (this.m_x - tempBase.m_x) * (this.m_x - tempBase.m_x) +
                  (this.m_y - tempBase.m_y) * (this.m_y - tempBase.m_y) <=
                (Setting.AIRSTRIKE_AOE + 1) * (Setting.AIRSTRIKE_AOE + 1)
              ) {
          ...
          for (var i = 0; i < game.m_tanks[Enum.TEAM_1].length; i++) {
            ...
            if (tempTank.m_HP > 0) {
              if (
                (this.m_x - tempTank.m_x) * (this.m_x - tempTank.m_x) +
                  (this.m_y - tempTank.m_y) * (this.m_y - tempTank.m_y) <=
                Setting.EMP_AOE * Setting.EMP_AOE
              ) {
