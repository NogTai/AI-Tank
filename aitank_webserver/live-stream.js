...
//     target: {
//       host: configuration.GAME_SERVER_IP,
...
exports.addStream = function (gameId, gamePort) {
  streamList.set(gameId.toString(), gamePort.toString());
};

exports.removeStream = function (gameId) {
  streamList.delete(gameId.toString());
};
